...
import { Gamepad2, ArrowLeft, CircleDot } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-4">
        ...
        >
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-3xl bg-gradient-to-br from-amber-500/20 to-mboa-surface-high border border-amber-500/20 mb-6">
          ...
          <p className="text-lg text-mboa-text-muted mb-2 max-w-md mx-auto">
            Stratégie premium inspirée des palais traditionnels camerounais.
          </p>
